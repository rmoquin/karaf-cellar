...
/**
 * This class represents an event that is broad-casted to the cluster. The event is always generated by a single node
 * (source) but can have none or multiple destinations.
 */
